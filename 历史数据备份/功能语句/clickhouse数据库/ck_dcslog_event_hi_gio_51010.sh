...
clickhouse-client -h 10.253.248.77 -n --receive_timeout=3600  --query="
...
ifNull(attributes['WT_ti'],attributes['$title']) as ti,
event_key as et, 
...
select user,session,client_time,
if(position(domain,'.')>0,if(match(domain,'^[0-9]+[.]+[0-9]+[.]+[0-9]+[.]+[0-9]+$'),concat('http://',ifNull(domain,''),ifNull(attributes['$path'],'')),concat('https://',ifNull(domain,''),ifNull(attributes['$path'],''))),domain) as url
FROM olap.event_all
WHERE toDate(event_time) = '2023-08-28'
and event_type = 'custom_event' 
and data_source_id in ('aae6afbf8823b1c1','a797613d647af6c6','a7464be8b200fe24','b9e74b9d5da046ce','b87eb8cec01051a6','b098587a3af15a25','b23efeab1461679b','a10b1f67c7d288c1','ae2308d5a08258b6','a04f0ad9925c080f','a6ba03d6884ee1c1','aa3a7b170aa41eed','a441e7427a44d390','adae9b8274a853f1','ad2e89b1010aed1e','bfe72e945deea64f','81ebc780373ee7cd','8d5d4407d1c3f6bf','abd580f08cf381e0','ba81a7647a8bed5d','8c19b47f237e28d3','a609de73d1690c0e','9c294cf845907ac1','b0839305cf5d280d','9a238b92b6612604','afdbd0f6b9a7ba30','8273883304ad70fb','86fdf7160c5cc8cc','81fab8d01c17ee89','89e7161d4a6b817f','9b50668a016469ec','bda85eeb52fb8b87','a8c29f7abfd639b4','b8d9fd437de471e4','875444ff6e049f33','853d176d98834573')
and domain like '%h5.ha.chinamobile.com%'
and attributes['$path'] like '%hnmccClientWap/act_h5/html/h5/account/flowManager%'
limit 1000
;


select mobile,ss_id,cli_time,
url
FROM webtrends.event_51010_tmp_all
WHERE dt = '2023-08-28'
and dcsid in ('aae6afbf8823b1c1','a797613d647af6c6','a7464be8b200fe24','b9e74b9d5da046ce','b87eb8cec01051a6','b098587a3af15a25','b23efeab1461679b','a10b1f67c7d288c1','ae2308d5a08258b6','a04f0ad9925c080f','a6ba03d6884ee1c1','aa3a7b170aa41eed','a441e7427a44d390','adae9b8274a853f1','ad2e89b1010aed1e','bfe72e945deea64f','81ebc780373ee7cd','8d5d4407d1c3f6bf','abd580f08cf381e0','ba81a7647a8bed5d','8c19b47f237e28d3','a609de73d1690c0e','9c294cf845907ac1','b0839305cf5d280d','9a238b92b6612604','afdbd0f6b9a7ba30','8273883304ad70fb','86fdf7160c5cc8cc','81fab8d01c17ee89','89e7161d4a6b817f','9b50668a016469ec','bda85eeb52fb8b87','a8c29f7abfd639b4','b8d9fd437de471e4','875444ff6e049f33','853d176d98834573')
and domain like '%h5.ha.chinamobile.com%'
limit 1000
;


select domain,attributes['$path'],
if(position(domain,'.')>0,if(match(domain,'^[0-9]+[.]+[0-9]+[.]+[0-9]+[.]+[0-9]+$'),concat('http://',ifNull(domain,''),ifNull(attributes['$path'],'')),concat('https://',ifNull(domain,''),ifNull(attributes['$path'],''))),domain) as url
FROM olap.event_all
WHERE toDate(event_time) = '2023-08-28'
and event_type = 'custom_event' 
and data_source_id in ('aae6afbf8823b1c1','a797613d647af6c6','a7464be8b200fe24','b9e74b9d5da046ce','b87eb8cec01051a6','b098587a3af15a25','b23efeab1461679b','a10b1f67c7d288c1','ae2308d5a08258b6','a04f0ad9925c080f','a6ba03d6884ee1c1','aa3a7b170aa41eed','a441e7427a44d390','adae9b8274a853f1','ad2e89b1010aed1e','bfe72e945deea64f','81ebc780373ee7cd','8d5d4407d1c3f6bf','abd580f08cf381e0','ba81a7647a8bed5d','8c19b47f237e28d3','a609de73d1690c0e','9c294cf845907ac1','b0839305cf5d280d','9a238b92b6612604','afdbd0f6b9a7ba30','8273883304ad70fb','86fdf7160c5cc8cc','81fab8d01c17ee89','89e7161d4a6b817f','9b50668a016469ec','bda85eeb52fb8b87','a8c29f7abfd639b4','b8d9fd437de471e4','875444ff6e049f33','853d176d98834573')
and user = '17888597660'
and session = '029a3675-9880-4200-b4b4-ce4141ce57f7'
and (toUnixTimestamp(client_time) * 1000 + CAST(splitByString('.', CAST(client_time, 'String'))[2], 'Int')) = '1693220334569'
;

insert into  ham.event_51010_test_local
select 
case when match(user, '^[0-9]{11}$') then user when match(user, '.*==$') and length(user)=24 then aes2_function(base64Decode(user)) end AS mobile,
--case when match(user, '^[0-9]{11}$') then user when match(user, '.*==$') and length(user)=24 then decrypt('aes-128-ecb',base64Decode(user), '9e5702ead4d643fd') end AS mobile,
--user AS mobile,
