...
SQL_start="
INSERT INTO TABLE ham_jituan.data_job_monitoring partition (dt = '${DT}',hour = '${Hour}',job_name = 'export_51007_hourly')
...
file_count=$(find /data/output/51007_hourly/${dfmt}/${dfmt}_${Hour} -name "*.gz" | wc -l )

SQL_end="

INSERT OVERWRITE TABLE ham_jituan.data_job_monitoring partition (dt = '${DT}',hour = '${Hour}',job_name = 'export_51007_hourly')
