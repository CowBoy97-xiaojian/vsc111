...
select*from hive.csap.TB DWD CT OLSP USER TRACK 51010 DAYwhere statis date = '20230819'and wt event = P00000061314
...
from olap.event_all
where toDate(event_time) = '2023-08-20'
--and event_key = 'P00000061314'
and attributes['WT_event'] = 'P00000061314'
