...
DT=$2
echo "拉取数据文件"
hdfs dfs -get /user/hive/warehouse/ham_jituan.db/ods_zhzt_jf_dm/dt=${DT}/*

date_airflow=$1
file_name="M_029_F40002_A202900002_02912_${date_airflow}_00_0001"
CHK_file_name="M_029_F40002_A202900002_02912_${date_airflow}_00"
file=${file_name}.txt
