...
b.advertype,
b.mark_id,
concat(b.advertype, '_', b.mark_id)
from (select marketing_id from ham.dim_client_ord_info_d_all where dt='2023-04-07') a
,(select advertype,mark_id from webtrends.event_hi_client_all where dt= '2023-04-07' and trmnl_style in ('b508a809cbbddd0b','IOS') and advertype = '29') b
where concat(b.advertype, '_', b.mark_id) = a.marketing_id;
