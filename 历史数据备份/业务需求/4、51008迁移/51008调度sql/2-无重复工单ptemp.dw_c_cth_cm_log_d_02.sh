...
clickhouse-client -h 10.253.248.73 -m --database="ham" --receive_timeout=3600 --query="truncate table ham.tmp_c_cth_cm_log_d_02_local on cluster cluster_gio_with_shard "

clickhouse-client -h 10.253.248.73 -m --database="ham" --receive_timeout=3600 --query="
insert into table ham.tmp_c_cth_cm_log_d_02_all
select  serial_id           
,start_time          
,down_time           
,status              
