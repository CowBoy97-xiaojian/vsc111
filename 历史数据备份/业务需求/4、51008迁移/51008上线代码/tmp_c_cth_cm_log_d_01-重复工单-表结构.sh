...
#表---tmp_c_cth_cm_log_d_01_local---重复工单表
#字段
serial_id String, 
start_time String, 
down_time String, 
...
#分布式表——本地
CREATE TABLE ham.tmp_c_cth_cm_log_d_01_local on cluster cluster_gio_with_shard
(
serial_id String, 
start_time String, 
down_time String, 
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{shard}/ham.tmp_c_cth_cm_log_d_01_local', '{replica}')
ORDER BY (marketing_id,frequency,icon_code)
SETTINGS index_granularity = 8192, storage_policy = 'multiple_disk';


#分布式表——视图
CREATE TABLE ham.tmp_c_cth_cm_log_d_01_all on cluster cluster_gio_with_shard
as ham.tmp_c_cth_cm_log_d_01_local
ENGINE = Distributed('cluster_gio_with_shard', 'ham', 'tmp_c_cth_cm_log_d_01_local', rand());
