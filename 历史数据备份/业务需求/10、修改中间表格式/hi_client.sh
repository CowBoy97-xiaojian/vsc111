CREATE TABLE webtrends.event_hi_client_t_local on cluster cluster_gio_with_shard
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/tables/{shard}/webtrends.event_hi_client_local1', '{replica}')
...
CREATE TABLE webtrends.event_hi_client_t_all on cluster cluster_gio_with_shard
as webtrends.event_hi_client_t_local
ENGINE = Distributed('cluster_gio_with_shard', 'webtrends', 'event_hi_client_t_local', rand());