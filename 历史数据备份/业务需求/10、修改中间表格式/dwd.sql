CREATE TABLE webtrends.dwd_client_event_local
(
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{shard}/webtrends.dwd_client_event_local', '{replica}')
PARTITION BY (dt, hour)
ORDER BY (dcsdat, user_agent)
