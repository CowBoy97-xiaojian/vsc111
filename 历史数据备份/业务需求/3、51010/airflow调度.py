...
with DAG('rpt_51010_ck_daily',
    ...
    etl_ads_rpt_hachi_51010 = BashOperator(
        task_id="etl_ads_rpt_hachi_51010",
        bash_command=f"""
        sh /home/udbac/bin/rpt_51010_ck_daily_new.sh {DT} 12 {outputpath} {ffmt}
        """  ,
        dag=dag,
    )
    ...
    etl_ads_rpt_hachi_51010 #>> push_51010
