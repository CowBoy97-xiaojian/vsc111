CREATE TABLE webtrends.event_hi_dcslog_local on cluster cluster_gio_with_shard
(
...
ENGINE = ReplicatedReplacingMergeTree('/clickhouse/tables/{shard}/webtrends.event_hi_dcslog_local', '{replica}')
...
CREATE TABLE webtrends.event_hi_dcslog_all on cluster cluster_gio_with_shard
as webtrends.event_hi_dcslog_local
ENGINE = Distributed('cluster_gio_with_shard', 'webtrends', 'event_hi_dcslog_local', rand());