CREATE TABLE webtrends.event_51010_tmp_local on cluster cluster_gio_with_shard
(
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{shard}/webtrends.event_51010_tmp_local', '{replica}')
...
CREATE TABLE webtrends.event_51010_tmp_all on cluster cluster_gio_with_shard
as webtrends.event_51010_tmp_local
ENGINE = Distributed('cluster_gio_with_shard', 'webtrends', 'event_51010_tmp_local', rand());