CREATE TABLE webtrends.event_hi_client_new_local on cluster cluster_gio_with_shard
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{shard}/webtrends.event_hi_client_new_local', '{replica}')
...
CREATE TABLE webtrends.event_hi_client_new_all on cluster cluster_gio_with_shard
as webtrends.event_hi_client_new_local
ENGINE = Distributed('cluster_gio_with_shard', 'webtrends', 'event_hi_client_new_local', rand());
