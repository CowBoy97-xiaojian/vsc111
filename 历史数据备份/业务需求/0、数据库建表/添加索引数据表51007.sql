CREATE TABLE webtrends.event_hi_client_index_local on cluster cluster_gio_with_shard
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{shard}/webtrends.event_hi_client_index_local', '{replica}')
...
CREATE TABLE webtrends.event_hi_client_index_all on cluster cluster_gio_with_shard
as webtrends.event_hi_client_index_local
ENGINE = Distributed('cluster_gio_with_shard', 'webtrends', 'event_hi_client_index_local', rand());

ENGINE = Distributed('cluster_gio_with_shard', 'olap', 'event_local', abs(javaHash(toString(gio_id)))) │

CREATE INDEX index_dcsid ON webtrends.event_hi_client_index_local(dcsid) TYPE bloom_filter GRANULARITY 65536;