CREATE TABLE webtrends.evevent_hi_client_imp_local on cluster cluster_gio_with_shard
...
ENGINE = ReplicatedMergeTree('/clickhouse/tables/{shard}/webtrends.evevent_hi_client_imp_local', '{replica}')
...
CREATE TABLE webtrends.evevent_hi_client_imp_all on cluster cluster_gio_with_shard
as webtrends.evevent_hi_client_imp_local
ENGINE = Distributed('cluster_gio_with_shard', 'webtrends', 'evevent_hi_client_imp_local', rand());
