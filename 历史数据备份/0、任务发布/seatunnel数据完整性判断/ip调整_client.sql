...
--split(tb1.ip,'\\|')[0] as c_ip,
if(instr(tb1.ip,'|')>0,split(tb1.ip,'\\|')[0],tb1.ip) as c_ip,
...
case when data_source_id in ('a1f48d9ff4f42571','b508a809cbbddd0b') then concat('APP_',lower(os),'_',client_version)
else attributes['WT_av'] end as wt_av,
