...
upload_file() {
  ...
  while [ $retry_count -lt $max_retries ]; do
    ...
    lftp -u 'sftp_coc270,SFtp_cOc270!' -p 3968 sftp://10.252.180.2/incoming/cmccsales_270cm/  -e "mput -c $file; exit;"
...
INSERT OVERWRITE TABLE ham_jituan.data_job_monitoring partition (dt = '${dt}',hour = '23',job_name = 'push_51010_daily')
values ('51010','${start_time}','${end_time}','','','','','运行完毕');
