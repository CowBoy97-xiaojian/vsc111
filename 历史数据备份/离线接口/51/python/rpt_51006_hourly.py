...
def failure_callback(context):
    ...
    return DingdingOperator(
        ...
        message=message,
        at_all=False,
        at_mobiles=['18951846665','17612930601','18338395282','15309476679','13921442403','18715511862','13814022856','13948869613']
    ).execute(context)
...
with DAG('rpt_51006_hourly',
    ...
    transform_name_daily = BashOperator(
        ...
        then
           ...
           flag_sum=$(($(ls -l -R /home/udbac/output/51006_hourly/{dfmt} | grep flag | wc -l)+$(ls -l -R /home/udbac/output/51006_gio_hourly/{dfmt} | grep flag | wc -l)))
           if [ '48' -eq $flag_sum ]
           then
             sh /home/udbac/bin/transform_name_cp_51006.sh {dfmt} {DT}
             echo "合并文件完成"
           else
             #等待30分钟，再进行重跑
             sleep 1800
    ...
    push_51006 = BashOperator(
        ...
        cd /home/udbac/output/51006_hourly/{dfmt}/
        if [ '23' -eq {HH} ];then
           sh /home/udbac/bin/new_push_51006.sh {DT}
           ct=$(ls *.dat.gz | wc -l)
