...
becsv_cmd = f"""/home/udbac/beeline/CDH-5.16.2-1.cdh5.16.2.p0.8/bin/beeline -i /home/udbac/.hiverc  --nullemptystring=true --showHeader=false --outputformat=csv2 \
...
with DAG('etl_client_dcslog_gio_hourly',
    ...
    insert_51007_hourly = BashOperator(
        task_id="insert_51007_hourly",
        bash_command=f"""
       # sleep 900 
       # sh /data/bin/insert_hive.sh {DT} {HH}
         sh  /home/udbac/bin/wait_ck_insert.sh {DT} {HH}
         if [ $? == 99 ]
         then
    ...
    etl_dwd_client_event_di_gio = BashOperator(
        task_id='etl_dwd_client_event_di_gio',
        bash_command=be_cmd + 'jituan/etl_dwd_client_event_di_gio.hql',
        on_failure_callback=failure_callback,
        dag=dag,
    )

    insert_51006_hourly = BashOperator(
        task_id="insert_51006_hourly",
        bash_command=f"""
        #sleep 1800 
        #sh /home/udbac/bin/insert_hive_H5.sh {DT} {HH}
        sh -x /home/udbac/bin/wait_ck_insert_06.sh {DT} {HH}
        """,
        dag=dag,
        max_active_tis_per_dag=4
    )

    etl_dwd_dcslog_event_di_gio = BashOperator(
        task_id='etl_dwd_dcslog_event_di_gio',
        bash_command=be_cmd + 'h5/etl_dwd_dcslog_event_di_gio.hql',
     #   bash_command=f"""
     #   sh /home/udbac/bin/check_ods_client_gio.sh {DT} {HH} /home/udbac/hqls/h5/etl_dwd_dcslog_event_di_gio.hql
     #   """,
        on_failure_callback=failure_callback,
        dag=dag,
    ...
    insert_51007_hourly >> etl_dwd_client_event_di_gio
    insert_51007_hourly >> insert_51006_hourly >> etl_dwd_dcslog_event_di_gio
