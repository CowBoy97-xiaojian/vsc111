...
be_cmd = f"beeline -i /home/udbac/.hiverc -u {HS2} -n udbac --hivevar DT={DT} --hivevar HH={HH} -f /data/hqls/"

be_cmd2 = f"beeline -i /home/udbac/.hiverc -u {HS2} -n udbac --hivevar DT={DT} --hivevar HH={hfmt} -f /data/hqls/"
...
becsv_cmd = f"""/home/udbac/beeline/CDH-5.16.2-1.cdh5.16.2.p0.8/bin/beeline --nullemptystring=true --showHeader=false --outputformat=csv2 \
                   --silent=true -u {HS2} -n udbac --hivevar DT={DT}  --hivevar HH={HH} -f /data/hqls/"""
...
with DAG('etl_client_gio_hourly',
