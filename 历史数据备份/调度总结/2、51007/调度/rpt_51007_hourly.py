...
with DAG('rpt_51007_hourly',
    ...
    export_51007_hourly = BashOperator(
        ...
        export_sum=$(cat /data/output/51007_hourly/{dfmt}/{dfmt}_{HH}/export_{DT}_JZYY_XTB2_51007_{HH}.log)
        hive_sum=$(cat /data/output/51007_hourly/{dfmt}/{dfmt}_{HH}/hive_{DT}_JZYY_XTB2_51007_{HH}.log)
        if [ $export_sum -ne $hive_sum ]
