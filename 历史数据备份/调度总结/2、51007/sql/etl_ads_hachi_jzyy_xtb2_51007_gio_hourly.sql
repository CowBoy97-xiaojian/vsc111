[udbac@new-airflow-2 ~/airflow/dags]$ cat /home/udbac/hqls//jituan/etl_ads_hachi_jzyy_xtb2_51007_gio_hourly.hql
...
select
   ...
   -- decode_url(regexp_replace(wt_es,'\\n+|\\r+|(\\n\\r)+|\\t+|\\|', '')) wt_es,
    regexp_replace(decode_url(wt_es),'\\n+|\\r+|(\\n\\r)+|\\t+|\\|', '') wt_es,
    ...
    regexp_replace(decode_url(a_dc), '\\n+|\\r+|(\\n\\r)+|\\t+|\\|', '') as a_dc,
    regexp_replace(ct,'\\n+|\\r+|(\\n\\r)+|\\t+|\\|', '') as ct,
    regexp_replace(sr,'\\n+|\\r+|(\\n\\r)+|\\t+|\\|', '') as sr,
    ...
    regexp_replace(decode_url(envname), '\\n+|\\r+|(\\n\\r)+|\\t+|\\|', '') as envname,
    --decode_url(regexp_replace(next_url, '\\n+|\\r+|(\\n\\r)+|\\t+|\\|', '')) as next_url,
    regexp_replace(decode_url(next_url), '\\n+|\\r+|(\\n\\r)+|\\t+|\\|', '') as next_url,
