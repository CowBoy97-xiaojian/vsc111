...
with DAG('etl_dcslog_hourly_gio',
    ...
    etl_dwd_dcslog_event_di_gio_51006 = BashOperator(
        task_id='etl_dwd_dcslog_event_di_gio_51006',
        bash_command=be_cmd + 'h5/etl_dwd_dcslog_event_di_gio_51006.hql',
        on_failure_callback=failure_callback,
        dag=dag,
        max_active_tis_per_dag=3
    )

    etl_dwd_dcslog_event_di_gio_51010 = BashOperator(
        task_id='etl_dwd_dcslog_event_di_gio_51010',
        bash_command=be_cmd + 'h5/etl_dwd_dcslog_event_di_gio_51010.hql',
        on_failure_callback=failure_callback,
        dag=dag,
        max_active_tis_per_dag=3
    )

    insert_51006_hourly >> etl_dwd_dcslog_event_di_gio_51006 >> etl_dwd_dcslog_event_di_gio_51010
