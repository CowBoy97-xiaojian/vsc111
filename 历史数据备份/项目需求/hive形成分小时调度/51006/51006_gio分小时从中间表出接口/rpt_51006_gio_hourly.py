...
with DAG('rpt_51006_gio_hourly',
    ...
    sensor_etl_dcslog_51006_gio_hourly = ExternalTaskSensor(
        task_id="sensor_etl_dcslog_51006_gio_hourly",
        external_dag_id='etl_dcslog_hourly_gio',
        external_task_id='etl_dwd_dcslog_event_di_gio_51006',
        timeout=3600,
