...
ip,
ip2region(ip) as ip_area,
splitByString('|',ip_area)[1] as ip_prov,
splitByString('|',ip_area)[2] as ip_city,
...
splitByString('?',ifNull(es,''))[1] as url,
decodeURLComponent(es) as complete_url,
...
WHERE dt = '2023-06-28'
and hour = '10'
and data_source_id in ('dcscx966fo4l7j258ag0s874n_3w7x')
)tb1
left join(
select
anonymous_user,
